...
public class EntityHexePod extends ElementswyrmsofnyrusMod.ModElement {
	public static final int ENTITYID = 9;
	public static final int ENTITYID_RANGED = 10;
	public EntityHexePod(ElementswyrmsofnyrusMod instance) {
		super(instance, 24);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("wyrmsofnyrus", "hexe_pod"), ENTITYID).name("hexe_pod").tracker(256, 3, true).egg(-7981824, -154).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelhexepod(), 0.5f) {
	...
	public static class EntityCustom extends EntityMob {
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation("entity.enderdragon_fireball.explode"));
		}
