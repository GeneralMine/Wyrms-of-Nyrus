...
public class ItemWyrmico extends AutoReg.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("wyrmsofnyrus:wyrmico", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 1;
			setUnlocalizedName("wyrmico");
			setRegistryName("wyrmico");
			setCreativeTab(null);
		}
