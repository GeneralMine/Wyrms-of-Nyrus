...
public class WorldConfig {
    ...
    public static void loadFromConfig(Configuration config) {
        ...
        creepBlocksStopSpawns = createConfigBool(config, CATEGORY, "Blocks stop mob spawns", "Creep blocks will stop mobs from spawning normally on them. The Creeped will still be spawned on these blocks, should the rules check out. Default: true", true);
        ...
        follyBlocksStopSpawns = createConfigBool(config, CATEGORYTWO, "Blocks stop mob spawns", "Folly blocks don't stop normal mobs from spawning on them by default. Enable this if you think that wyrmfollies are getting extremely powerful due to them killing mobs spawning in their territory. Default: false", false);
    }
}
